//
//  HorizontalMovieCollectionViewControllerTests.swift
//  MovieChallangeTests
//
...
final class HorizontalMovieCollectionViewControllerTests: XCTestCase {
    var window: UIWindow!
    private var viewController: HorizontalMovieCollectionViewController!
    ...
    private func createViewController(with viewModel: MovieSearchViewModel) {
        viewController = HorizontalMovieCollectionViewController(viewModel: viewModel)
    ...
    func testFetching() throws {
        ...
        DispatchQueue.main.async {
            ...
            XCTAssertEqual(self.viewController.collectionView(self.viewController.collectionView, numberOfItemsInSection: 0), 2)
    ...
    func testFetchingWithPagination() throws {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            ...
            XCTAssertEqual(self.viewController.collectionView(self.viewController.collectionView, numberOfItemsInSection: 0), 4)
    ...
    func testFetchingFailing() throws {
        ...
        DispatchQueue.main.async {
            if case .failed(_) = viewModel.statusSubscriber.value {
                ...
                XCTAssertEqual(self.viewController.collectionView(self.viewController.collectionView, numberOfItemsInSection: 0), 0)
